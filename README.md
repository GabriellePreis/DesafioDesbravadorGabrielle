...
Oláaa! 
Escrevi este código para testes automáticos com Cypress:

- Acessei a página de reservas;
- Selecionei um intervalo de datas;
- Adicionei 2 adultos e 1 criança.

Porém, encontrei dificuldades para avançar devido ao reCaptcha e alguns comportamentos do sistema.
