...
- Adicionei 2 adultos e 1 criaça.

Porém, encontrei dificuldades para avançar devido o reCaptcha e alguns comportamentos do sistema.
De acordo com a regra de negócio, o reCapctha é obrigatório para verificar a disponibilidade de reserva, mas por questões de segurança não é possível automatizar essa verificação.
